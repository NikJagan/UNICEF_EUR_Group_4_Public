...
asie <- ALEPlot(df_train, rf_model, pred.fun=yhat, J="Azië",K=20, NA.plot = F)
...
plot(asie$x.values, asie$f.values, type="l", xlab="% of Asian nationals", ylab="", ylim=c(-0.05, 0.2))
...
par(mfrow = c(2,2), mar=c(4, 4, 5, 1), oma=c(2,2,4,2), bg=bg_col)
plot(ned$x.values, ned$f.values, type="l", xlab="% of Dutch nationals", ylab="", ylim=c(-0.05, 0.2),cex.axis=1.1, cex.lab=1.5)
mtext("ALE main effect of nationality on online donations", side=3, outer=TRUE, cex=2)
plot(afrika$x.values, afrika$f.values, type="l", xlab="% of African nationals", ylab="", ylim=c(-0.05, 0.2),cex.axis=1.1, cex.lab=1.5)
plot(asie$x.values, asie$f.values, type="l", xlab="% of Asian nationals", ylab="", ylim=c(-0.05, 0.2),cex.axis=1.1, cex.lab=1.5)
plot(amerika$x.values, amerika$f.values, type="l", xlab="% of American nationals", ylab="", ylim=c(-0.05, 0.2),cex.axis=1.1, cex.lab=1.5)
mtext("Increase in online donations", side=2, line=0.6, cex=1.5, outer=TRUE)
dev.off()
...
png("fig11_cultural_interaction.png", width = 8, height = 12, units = 'in', res = 500)
par(mfrow = c(3,3), mar=c(4, 5, 3, 1), oma=c(3,3,5,1))
image(as.integer(nl$x.values[[1]]), nl$x.values[[2]], nl$f.values,xlab = "the Netherlands", ylab = "Dutch", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
mtext("Darker colours indicate higher online donation count", side=3, adj=-1,line=1, cex=1)
image(as.integer(vorm_nl$x.values[[1]]), vorm_nl$x.values[[2]], vorm_nl$f.values, xlab = "the Netherlands", ylab = "the Netherlands Antilles", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(EU$x.values[[1]]), EU$x.values[[2]], EU$f.values, xlab = "Europe (excl.NL)", ylab = "European", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
mtext("ALE effect plot for cultural proximities", side=3, line=1.5, cex=2, outer=TRUE)
image(as.integer(ind$x.values[[1]]), ind$x.values[[2]], ind$f.values, xlab = "Indonesia", ylab = "Indonesian", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(surinam$x.values[[1]]), surinam$x.values[[2]], surinam$f.values, xlab = "Surinam", ylab = "Surinamese", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(turkey$x.values[[1]]), turkey$x.values[[2]], turkey$f.values, xlab = "Turkey", ylab = "Turkish", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(africa$x.values[[1]]), africa$x.values[[2]], africa$f.values, xlab = "Africa", ylab = "African", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(america$x.values[[1]]), america$x.values[[2]], america$f.values, xlab = "America", ylab = "American", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(asia$x.values[[1]]), asia$x.values[[2]], asia$f.values, xlab = "Asia", ylab = "Asian", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
mtext("Place where event happened (1=event happened)", side=1, line=1.5, cex=1.5, outer=TRUE)
mtext("% of specific cultural background in zipcode", side=2, line=1.5, cex=1.5, outer=TRUE)
dev.off()

#plots for presentation
png("prezzo_cultural_interaction.png", width = 8, height = 10, units = 'in', res = 500)
par(mfrow = c(2,2), mar=c(4, 5, 3, 1), oma=c(3,3,5,1), bg=bg_col)
image(as.integer(nl$x.values[[1]]), nl$x.values[[2]], nl$f.values,xlab = "the Netherlands", ylab = "Dutch", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
mtext("Darker colours indicate higher online donation count", side=3,line=1, cex=1)
mtext("ALE effect plot for cultural proximities", side=3, line=1.5, cex=2, outer=TRUE)
image(as.integer(africa$x.values[[1]]), africa$x.values[[2]], africa$f.values, xlab = "Africa", ylab = "African", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(america$x.values[[1]]), america$x.values[[2]], america$f.values, xlab = "America", ylab = "American", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
...
png("fig12_location_interaction.png", width = 10, height = 10, units = 'in', res = 500)
par(mfrow = c(1,3), mar=c(4, 4, 5, 1), oma=c(2,4,5,3))
image(as.integer(nl_loc$x.values[[1]]), nl_loc$x.values[[2]], nl_loc$f.values,xlab = "Event in NL", ylab = "", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
mtext("Darker colours indicate higher online donation count", side=3,line=1, cex=1)
image(as.integer(eu_loc$x.values[[1]]), eu_loc$x.values[[2]], eu_loc$f.values, xlab = "Event in EU", ylab = "", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(world_loc$x.values[[1]]), world_loc$x.values[[2]], world_loc$f.values, xlab = "Event elsewhere", ylab = "", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
mtext("% of Dutch in zipcode", side=2, line=1, cex=1.5, outer=TRUE)
mtext("ALE effect plot for location proximities", side=3, line=1, cex=2, outer=TRUE)
dev.off()
...
png("fig13_pledge-demographic_interaction.png", width = 10, height = 12, units = 'in', res = 500)
par(mfrow = c(3,3), mar=c(5, 5, 4, 1), oma=c(4,4,5,3))
image(as.integer(nl_dm$x.values[[1]]), nl_dm$x.values[[2]], nl_dm$f.values,xlab = "", ylab = "Dutch", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
mtext("Darker colours indicate higher online donation count", side=3, adj=-1,line=1, cex=1)
image(as.integer(vorm_nl_dm$x.values[[1]]), vorm_nl_dm$x.values[[2]], vorm_nl_dm$f.values, xlab = "", ylab = "the Netherlands Antilles", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(eu_dm$x.values[[1]]), eu_dm$x.values[[2]], eu_dm$f.values, xlab = "", ylab = "European", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(tk_dm$x.values[[1]]), tk_dm$x.values[[2]], tk_dm$f.values, xlab = "", ylab = "Turkish", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
mtext("ALE effect plot for demographics * pledges interaction", side=3, line=1, cex=2, outer=TRUE)
image(as.integer(ind_dm$x.values[[1]]), ind_dm$x.values[[2]], ind_dm$f.values, xlab = "", ylab = "Indonesian", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(sur_dm$x.values[[1]]), sur_dm$x.values[[2]], sur_dm$f.values, xlab = "", ylab = "Surinamese", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(afr_dm$x.values[[1]]), afr_dm$x.values[[2]], afr_dm$f.values, xlab = "", ylab = "African", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(am_dm$x.values[[1]]), am_dm$x.values[[2]], am_dm$f.values, xlab = "", ylab = "American", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(as_dm$x.values[[1]]), as_dm$x.values[[2]], as_dm$f.values, xlab = "", ylab = "Asian", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
mtext("Presence of pledge in zip code (1=pledge happened)", side=1, line=1, cex=1.5, outer=TRUE)
mtext("% of specific cultural background in zipcode", side=2, line=1, cex=1.5, outer=TRUE)
dev.off()

#plots for presentation
png("prezzo_pledge-demographic_interaction.png", width = 8, height = 10, units = 'in', res = 500)
par(mfrow = c(2,2), mar=c(4, 5, 4, 1), oma=c(3,4,5,4), bg=bg_col)
image(as.integer(nl_dm$x.values[[1]]), nl_dm$x.values[[2]], nl_dm$f.values,xlab = "", ylab = "Dutch", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
mtext("Darker colours indicate higher online donation count", side=3, adj=-1.5,line=1, cex=1)
mtext("ALE effect plot for demographics * pledges interaction", side=3, line=1.5, cex=2, outer=TRUE)
image(as.integer(afr_dm$x.values[[1]]), afr_dm$x.values[[2]], afr_dm$f.values, xlab = "", ylab = "African", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
image(as.integer(am_dm$x.values[[1]]), am_dm$x.values[[2]], am_dm$f.values, xlab = "", ylab = "American", col=colour_palette, xaxt="n", cex.lab=1.6, cex.axis=1.2)
axis(1, at=c(0,1),labels=c("0","1"), cex.axis=1.2)
